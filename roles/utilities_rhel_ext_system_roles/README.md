# Role: infra.ado.utilities_rhel_ext_system_roles
...
| `utilities_rhel_ext_system_roles_roles_map` | `dict` | Override map of short keys to upstream collection/role identifiers. |
  ...
  tasks:
    - name: Apply selected RHEL system roles
      ansible.builtin.include_role:
        name: infra.ado.utilities_rhel_ext_system_roles
      vars:
        sr_apply:
          - timesync
          - selinux
...
- `extensions/molecule/integration_utilities_rhel_ext_system_roles/molecule.yml`
- `extensions/molecule/utils/playbooks/utilities_rhel_ext_system_roles_prepare.yml`
- `extensions/molecule/utils/playbooks/utilities_rhel_ext_system_roles_converge.yml`
- `extensions/molecule/utils/playbooks/utilities_rhel_ext_system_roles_verify.yml`
- `extensions/molecule/utils/playbooks/utilities_rhel_ext_system_roles_destroy.yml`
