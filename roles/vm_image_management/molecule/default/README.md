...
- `destroy.yml`: Removes the temporary test artifacts under `/tmp/vm_image_management_molecule`.
...
- Temporary test files are created under `/tmp/vm_image_management_molecule` and removed during `destroy`.
